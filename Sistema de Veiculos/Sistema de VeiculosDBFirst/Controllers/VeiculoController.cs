...
using Sistema_de_VeiculosDBFirst.Data;
using Sistema_de_VeiculosDBFirst.Models;

namespace Sistema_de_VeiculosDBFirst.Controllers
{
    public class VeiculoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Ano,TipoVeiculo")] TabelaVeiculo tabelaVeiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Ano,TipoVeiculo")] TabelaVeiculo tabelaVeiculo)
        {
